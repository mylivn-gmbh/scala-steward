...
class VersionTest
  ...
  test("selectNext, table 3") {
    val nextVersions = Table(
      ...
      ("0.0.3-dev-1", List("0.0.3", "0.0.2-dev-99", "0.0.2"), Some("0.0.3")),
      ("0.0.3-dev-1", List("0.0.3", "0.0.3-dev-2", "0.0.2-dev-99", "0.0.2"), Some("0.0.3-dev-2")),
      ("0.0.3-dev-1", List("0.0.3-dev-3", "0.0.3-dev-21"), Some("0.0.3-dev-21"))
    )
